...
/// <summary>
/// Представляет коллекцию, обслуживаемую по принципу "последним пришел - первым вышел" (LIFO).
/// </summary>
...
public class TrivialStack<T> : IStack<T>
{
    ...
    public T? Peek() => IsEmpty ? throw new InvalidOperationException("Стек является пустым.") : _last!.Data;
}